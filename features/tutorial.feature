Feature: 주간리포트 테스트 데이터 셋 생성 ( https://docs.google.com/spreadsheets/d/1VaCwzePrZdsEmM43sieEfD8eRdeeXZYh_xn9sg5eZjE/edit#gid=1809453365 )
  ...
  Scenario: 광비우스 4차_주간 리포트 시나리오 - CASE25 - 클릭률 ( 내 서치리스팅 클릭률이 광고주 평균보다 낮음 )
    ...
    When 오픈리스팅광고로 wsIdx가 22887인 광고주에 소재아이디가 2548인 노출이 2022-06-13 10:23:59의 시점에 비딩가가 100원인 10번이 들어간 하나의 노출 row가 10회 쌓인다.
    When 오픈리스팅광고로 wsIdx가 22887인 광고주에 소재아이디가 2548인 노출이 2022-06-14 10:23:59의 시점에 비딩가가 120원인 10번이 들어간 하나의 노출 row가 30회 쌓인다.
    When 오픈리스팅광고로 wsIdx가 22887인 광고주에 소재아이디가 2548인 노출이 2022-06-15 10:23:59의 시점에 비딩가가 120원인 10번이 들어간 하나의 노출 row가 20회 쌓인다.
    When 오픈리스팅광고로 wsIdx가 22887인 광고주에 소재아이디가 2548인 노출이 2022-06-16 10:23:59의 시점에 비딩가가 120원인 10번이 들어간 하나의 노출 row가 30회 쌓인다.
    When 오픈리스팅광고로 wsIdx가 22887인 광고주에 소재아이디가 2548인 노출이 2022-06-17 10:23:59의 시점에 비딩가가 120원인 10번이 들어간 하나의 노출 row가 10회 쌓인다.
    When 오픈리스팅광고로 wsIdx가 22887인 광고주에 소재아이디가 2548인 클릭이 2022-06-13 10:23:59의 시점에 비딩가가 100원인 1번이 들어간 하나의 클릭 row가 2회 쌓인다.
    When 오픈리스팅광고로 wsIdx가 22887인 광고주에 소재아이디가 2548인 클릭이 2022-06-14 10:23:59의 시점에 비딩가가 120원인 1번이 들어간 하나의 클릭 row가 5회 쌓인다.
    When 오픈리스팅광고로 wsIdx가 22887인 광고주에 소재아이디가 2548인 클릭이 2022-06-15 10:23:59의 시점에 비딩가가 120원인 1번이 들어간 하나의 클릭 row가 6회 쌓인다.
    When 오픈리스팅광고로 wsIdx가 22887인 광고주에 소재아이디가 2548인 클릭이 2022-06-16 10:23:59의 시점에 비딩가가 120원인 1번이 들어간 하나의 클릭 row가 9회 쌓인다.
    When 오픈리스팅광고로 wsIdx가 22887인 광고주에 소재아이디가 2548인 클릭이 2022-06-17 10:23:59의 시점에 비딩가가 120원인 1번이 들어간 하나의 클릭 row가 10회 쌓인다.
       # 과금이 0원 초과가 되어야 주간 리포트가 생성 되므로 강제로 발생 시킨다.
