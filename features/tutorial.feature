Feature: 주간리포트 테스트 데이터 셋 생성 ( https://docs.google.com/spreadsheets/d/1VaCwzePrZdsEmM43sieEfD8eRdeeXZYh_xn9sg5eZjE/edit#gid=1809453365 )
  ...
  Scenario: 광비우스 4차_주간 리포트 시나리오 - CASE5 - 평균 광고비용 ( 내 오픈리스팅 사용 금액이 광고주 평균보다 낮음 )
    Given 광고테스트를 위한 기존 스키마를 그대로 이용한다.
    # 오픈리스팅 사용 금액 생성 ==>  130 + (110*2) + (120*2) + 200 + 300 + (100*3) +100 + (300*2) + (250*2) + (350*2) + (250*3) + (200*2) + (270*3) + (220*3) + 300 + (220*3) + (140*3) + (200*3) + (110*4) + (100*5) + 170 + (100*2) + (120*2) + 100 + (150*3) = 10000
    ...
    Given 광고테스트를 위한 기존 스키마를 그대로 이용한다.
    # 오픈리스팅 사용 금액 생성 ==> (100*20) + (200*20) + (200*20) + (100*30) + (100*25) + (200*25) + (300*10) + (100*25) + (100*30) + (100*10)
