Feature: 주간리포트 테스트 데이터 셋 생성 ( https://docs.google.com/spreadsheets/d/1VaCwzePrZdsEmM43sieEfD8eRdeeXZYh_xn9sg5eZjE/edit#gid=1809453365 )
  ...
  Scenario: 광비우스 4차_주간 리포트 시나리오 - CASE17 - 평균 광고비용 ( 내 전체 사용 금액이 광고주 평균보다 낮음 )
    ...
    When 과금이 wsIdx가 22879인 광고주에 광고상품이 3으로 2022-06-16 10:23:59의 시점에 유상으로 100원 25회 발생했다.
    When 과금이 wsIdx가 22879인 광고주에 광고상품이 3으로 2022-06-17 10:23:59의 시점에 유상으로 200원 10회 발생했다.
    When 과금이 wsIdx가 22879인 광고주에 광고상품이 3으로 2022-06-17 18:23:59의 시점에 유상으로 250원 2회 발생했다.
  ...
  Scenario: 광비우스 4차_주간 리포트 시나리오 - CASE19 - 평균 광고비용 ( 내 전체 사용 금액이 광고주 평균과 동일 )
    ...
    When 과금이 wsIdx가 22881인 광고주에 광고상품이 3으로 2022-06-16 10:23:59의 시점에 유상으로 100원 50회 발생했다.
    When 과금이 wsIdx가 22881인 광고주에 광고상품이 3으로 2022-06-17 10:23:59의 시점에 유상으로 200원 20회 발생했다.
    When 과금이 wsIdx가 22881인 광고주에 광고상품이 3으로 2022-06-17 18:23:59의 시점에 유상으로 250원 4회 발생했다.
  ...
  Scenario: 광비우스 4차_주간 리포트 시나리오 - CASE20 - 내 오픈리스팅 클릭률이 광고주 평균보다 높음
    ...
    When 과금이 wsIdx가 22882인 광고주에 광고상품이 3으로 2022-06-17 18:23:59의 시점에 유상으로 250원 4회 발생했다.
    Then 테스트 데이터 생성이 완료되었다.
