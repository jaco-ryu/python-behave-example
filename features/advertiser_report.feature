Feature: 외부리포트 테스트 데이터 셋 생성 ( https://docs.google.com/spreadsheets/d/10wSQTFcaJnPr1OHrqHxGxhPK1zlXf1rhuiBvNwNdR2M/edit#gid=930960577 )
  ...
  Scenario: CASE2 :: 서치리스팅 소재 2개 > "오늘" 날짜 이력 있음 > 그래프 시간대별 노출  > 데이터 확인
    ...
    # 2686 소재 찜 생성 ==> (1 * 1) = 1
    When wsIdx가 22959인 광고주에 소재아이디가 2686인 상단영역 찜이 2022-07-11 10:00:00의 시점에 1회 발생했다.
    # 2687 소재 찜 생성 ==> (1 * 1) = 1
    When wsIdx가 22959인 광고주에 소재아이디가 2687인 상단영역 찜이 2022-07-11 10:00:00의 시점에 1회 발생했다.
    # 2686 소재 매장방문 생성 ==> (1 * 1) = 1
    When wsIdx가 22959인 광고주에 소재아이디가 2686인 매장방문이 2022-07-11 10:00:00의 시점에 1회 발생했다.
    # 2687 소재 매장방문 생성 ==> (1 * 1) = 1
    When wsIdx가 22959인 광고주에 소재아이디가 2687인 매장방문이 2022-07-11 10:00:00의 시점에 1회 발생했다.
